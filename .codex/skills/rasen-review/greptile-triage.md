...
Shared reference for fetching, filtering, and classifying Greptile review comments on GitHub PRs. `/review` (Step 2.5) references this document.
...
PROJECT_HISTORY="$HOME/.openspec/projects/$REMOTE_SLUG/greptile-history.md"
```
...
- `~/.openspec/projects/$REMOTE_SLUG/greptile-history.md` (per-project)
- `~/.openspec/greptile-history.md` (global aggregate)
