...
- [x] 3.4 Obtain fixed Base/Head read-only architecture approval with P0=0 and P1=0.
- [x] 3.5 Install the exact Head APK on both devices and pass LAN disconnect→rediscovery→reconnect from an available selection entry without full Stop.
- [x] 3.6 Pass PR CI, merge by merge commit, pass exact-main CI, and synchronize KUM-41 evidence/state.
