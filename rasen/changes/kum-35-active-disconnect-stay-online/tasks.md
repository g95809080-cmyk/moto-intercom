...
- [ ] 4.4 Update Sprint 4 verification and RC physical plan with every hardware/OEM row `DEFERRED_TO_RELEASE_CANDIDATE`.

## 5. Review And Delivery

- [ ] 5.1 Commit atomically, push, open one KUM-35 Draft PR, and synchronize Linear while KUM-9 remains In Progress and KUM-36 remains Todo.
